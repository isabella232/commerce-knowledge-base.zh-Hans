...
* 支持工具 {#support-tools}
   ...
   * QPT工具中可用的修补程序 {#patches}
      ...
      * v1.1.48 {#v1-1-48}
         ...
         * [ACSD-57315：新事务处理创建于 [!DNL PayPal Payflow Pro] 每次单击“获取”按钮时](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-57315-new-transaction-created-in-paypal-payflow-pro-each-time-the-fetch-button-is-clicked.md)
         ...
         * [ACSD-56741：使用自定义MySQL触发器解决数据库设置错误](/help/support-tools/patches-available-in-qpt-tool/v1-1-48/acsd-56741-database-setup-upgrade-error-with-custom-mysql-trigger.md)
