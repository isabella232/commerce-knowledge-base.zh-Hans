...
MDVA-42768修补程序修复了以下问题：当可配置产品的子产品缺货时，GraphQL显示错误的价格。 此修补程序在以下情况下可用： [Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安装1.1.10。 修补程序ID为MDVA-42768。 请注意，该问题计划在Adobe Commerce 2.4.5中修复。
...
当可配置产品的子产品缺货，并且启用了显示缺货产品设置时，GraphQL查询会将产品的常规价格显示为 **0**.
...
1. 通过转至，在Commerce管理员中启用显示缺货产品设置。 **商店** > **配置** > **目录** > **库存**.
