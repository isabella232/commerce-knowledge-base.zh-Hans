...
ACSD-52689修补程序修复了无法使用REST API将图像上传到Amazon S3存储的问题。在以下情况下，此修补程序可用 [!DNL Quality Patches Tool (QPT)] 已安装1.1.34。 修补程序ID为ACSD-52689。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
