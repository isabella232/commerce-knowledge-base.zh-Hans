...
MDVA-38559修补程序修复了 `/V1/customers/search` 对于具有多个订阅的客户，API会返回错误。 此修补程序在以下情况下可用： [Quality Patches Tool (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 已安装1.1.15。 修补程序ID为MDVA-38559。 请注意，Adobe Commerce 2.4.3中已修复此问题。
...
`/V1/customers/search` 对于具有多个订阅的客户，API会返回错误。
...
1. 转到 **存储** > **配置** > **客户** > **客户配置** > **帐户共享选项** 并选择 **全局**.
1. 转到 **客户** > **所有客户**，选择 **编辑** ，然后选择 **新闻稿**.
1. 订阅多个网站的新闻稿并保存客户。
1. 发送以下请求：
...
以下错误记录到exception.log中： *已存在具有相同ID“1”的项目(Magento\Customer\Model\Customer\Interceptor)。*
