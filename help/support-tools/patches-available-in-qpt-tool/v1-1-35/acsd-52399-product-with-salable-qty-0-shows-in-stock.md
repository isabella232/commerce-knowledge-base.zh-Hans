...
ACSD-52399修补程序修复了可销售数量为零(0)的可配置产品选项显示的问题 *有货* 在产品页面上。 此修补程序在以下情况下可用： [!DNL Quality Patches Tool (QPT)] 已安装1.1.35。 修补程序ID为ACSD-52399。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
可销售数量为零(0)的可配置产品选项显示 *有货* 在产品页面上。
...
*[!UICONTROL Add to Cart]* 选择时按钮不可用 *缺货* 产品配置。
