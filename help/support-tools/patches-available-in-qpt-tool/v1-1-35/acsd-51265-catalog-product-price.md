...
ACSD-51265修补程序修复了 `catalog_product_price` 当系统中捆绑的产品过多时，重新索引性能会降低。 此修补程序在以下情况下可用： [!DNL Quality Patches Tool (QPT)] 已安装1.1.35。 修补程序ID为ACSD-51265。 请注意，该问题计划在Adobe Commerce 2.4.7中修复。
...
1. 生成至少具有下列条件的目录： *10,000* 捆绑产品，提供动态价格选项。
1. 运行产品价格重新指数。
