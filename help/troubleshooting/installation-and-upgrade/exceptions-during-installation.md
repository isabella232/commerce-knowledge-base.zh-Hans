---
title: 安装期间出现异常
description: 本文为使用Web安装向导安装Adobe Commerce时出现的问题提供了可能的解决方案。
...
本文为使用Web安装向导安装Adobe Commerce时出现的问题提供了可能的解决方案。
...
清除 `<magento_root>/generated/code` 下的其他目录 `var` 和 `generated` 如下所示：
